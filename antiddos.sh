...
echo "[+] Bloqueando DNS Amplification (porta 53 UDP)..."
iptables -A INPUT -p udp --dport 53 -m limit --limit 3/s --limit-burst 5 -j ACCEPT
iptables -A INPUT -p udp --dport 53 -j DROP

echo "[+] Bloqueando NTP Amplification (porta 123 UDP)..."
iptables -A INPUT -p udp --dport 123 -m limit --limit 2/s --limit-burst 3 -j ACCEPT
...
echo "[+] Limitando ping para evitar ping flood..."
